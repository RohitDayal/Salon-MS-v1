...
const CreateSalon = () => {
  ...
  //   const servicesSelected = Object.values(selectedServices).some(
  ...
  //     .catch((error) => {
  //       console.error("Error:", error);
  //       toast.error("Error creating salon. Please try again.", {
  //         position: "top-center",
  //       });
  //     });
  // };
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch("/create-saloon", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      console.error("Error:", error);
      toast.error(error.message || "Error creating salon. Please try again.", {
        position: "top-center",
      });
    }
  };
